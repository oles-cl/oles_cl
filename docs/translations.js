...
const translations = {
    es: {
        ...
        nav: {
            ...
            verTodas: "Ver todas →",
            verMas: "Ver más →",
            verEstudios: "Todos los estudios →"
        },
        // Secciones
        secciones: {
            ...
            verMasEquipo: "Ver más del equipo →"
        },
        // Equipo
        equipo: {
            directora: "Directora",
            ...
            verTesistasBtn: "Ver Tesistas y Pasantes →"
        },
        // Tipos
        tipos: {
            noticia: "Noticia",
        ...
        estudios: {
            ...
            cualitativos: {
                titulo: "🎙️ Estudios Cualitativos",
    ...
    en: {
        ...
        secciones: {
            ...
            verMasEquipo: "See more of the team →"
        },
        // Team
        equipo: {
            directora: "Director",
            ...
            verTesistasBtn: "View Thesis Students & Interns →"
        },
        // Types
        tipos: {
            noticia: "News",
...
// Mapeo de textos del navbar a claves de traducción
const navbarTranslations = {
    es: {
        ...
        '📊 Encuestas': '📊 Encuestas',
        '🎙️ Cualitativos': '🎙️ Cualitativos',
        '📰 Prensa y Redes': '📰 Prensa y Redes',
    ...
    en: {
        ...
        '📊 Encuestas': '📊 Surveys',
        '🎙️ Cualitativos': '🎙️ Qualitative',
        '📰 Prensa y Redes': '📰 Press & Social Media',
...
// Textos originales en español para referencia inversa
const originalTexts = {
    'Home': 'Inicio',
    'News': 'Noticias',
    ...
    '📊 Surveys': '📊 Encuestas',
    '🎙️ Qualitative': '🎙️ Cualitativos',
    '📰 Press & Social Media': '📰 Prensa y Redes',
...
function translateNavbar(lang) {
    ...
    document.querySelectorAll('.navbar .nav-link .menu-text, .navbar .dropdown-text').forEach(element => {
        ...
        // Si está en inglés, convertir a español primero y luego traducir
